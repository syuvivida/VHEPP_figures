...
%The response of the SiFCC detector to physics 
%process is simulated using the SLIC software package (``Simulator for 
%the Linear Collider'')~\cite{SLIC} developed for the ILC project. 
