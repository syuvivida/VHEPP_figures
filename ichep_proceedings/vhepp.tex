...
hadronically-decaying W bosons and Higgs bosons at very high energy proton 
...
boosted W-jets and Higgs-jets and show the separation of two sub-jets 
within the boosted boson jet.}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.5\textwidth]{figure1a.pdf} & 
\includegraphics[width=.5\textwidth]{figure1b.pdf}\\
\end{tabular}
\end{center}
\caption{The calorimeter energy response (left) and resolution (right) of a 
single pion as a function of true pion energy. %The solid lines indicate fits to 
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.4\textwidth]{figure2a.pdf} &
\includegraphics[width=.4\textwidth]{figure2b.pdf} \\
\end{tabular}
\end{center}
...
%The W-jet energy 
%resolution deteriorates as the jet energy increases, which is not expected. 
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.35\textwidth]{figure3a.pdf} &
\includegraphics[width=.35\textwidth]{figure3b.pdf} \\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.35\textwidth]{figure4a.pdf} &
\includegraphics[width=.35\textwidth]{figure4b.pdf}\\
\end{tabular}
\end{center}
\caption{
...
% doi:10.1088/1748-0221/11/09/P09012
% [arXiv:1604.01415 [physics.ins-det]].
  %%CITATION = doi:10.1088/1748-0221/11/09/P09012;%%
...
\bibitem{PROMC} 
%\cite{Chekanov:2013mma}
%\bibitem{Chekanov:2013mma} 
...
%  doi:10.1016/j.cpc.2014.06.016
%  [arXiv:1311.1229 [physics.comp-ph]].
  %%CITATION = doi:10.1016/j.cpc.2014.06.016;%%
  %6 citations counted in INSPIRE as of 21 Oct 2016
...
%  [arXiv:1403.1886 [hep-ph]].
  %%CITATION = doi:10.1155/2015/136093;%%
  %8 citations counted in INSPIRE as of 21 Oct 2016
...
%  doi:10.1088/1742-6596/78/1/012057
  %%CITATION = doi:10.1088/1742-6596/78/1/012057;%%
  %31 citations counted in INSPIRE as of 21 Oct 2016
